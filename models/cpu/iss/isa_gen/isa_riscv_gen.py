...
class Rv32i(IsaSubset):
    ...
    def __init__(self):
        super().__init__(name='rv32i', instrs=[
            ...
            Instr('jal',    Format_UJ,   '------- ----- ----- --- ----- 1101111', 'jal_decode', fast_handler=True, no_fast_wrapper=True),
            Instr('jalr',   Format_I,    '------- ----- ----- 000 ----- 1100111', fast_handler=True, no_fast_wrapper=True),
            Instr('beq',    Format_SB,   '------- ----- ----- 000 ----- 1100011', 'bxx_decode', fast_handler=True, no_fast_wrapper=True),
            Instr('bne',    Format_SB,   '------- ----- ----- 001 ----- 1100011', 'bxx_decode', fast_handler=True, no_fast_wrapper=True),
            Instr('blt',    Format_SB,   '------- ----- ----- 100 ----- 1100011', 'bxx_decode', fast_handler=True, no_fast_wrapper=True),
            Instr('bge',    Format_SB,   '------- ----- ----- 101 ----- 1100011', 'bxx_decode', fast_handler=True, no_fast_wrapper=True),
            Instr('bltu',   Format_SB,   '------- ----- ----- 110 ----- 1100011', 'bxx_decode', fast_handler=True, no_fast_wrapper=True),
            Instr('bgeu',   Format_SB,   '------- ----- ----- 111 ----- 1100011', 'bxx_decode', fast_handler=True, no_fast_wrapper=True),
...
class Rv32c(IsaSubset):
    ...
    def __init__(self):
        super().__init__(name='rv32c', instrs=[
            ...
            Instr('c.jal',      Format_CJ1, '001 --- --- -- --- 01', fast_handler=True, decode='jal_decode', no_fast_wrapper=True),
            ...
            Instr('c.j',        Format_CJ,  '101 --- --- -- --- 01', fast_handler=True, decode='jal_decode', no_fast_wrapper=True),
            Instr('c.beqz',     Format_CB1, '110 --- --- -- --- 01', fast_handler=True, decode='bxx_decode', no_fast_wrapper=True),
            Instr('c.bnez',     Format_CB1, '111 --- --- -- --- 01', fast_handler=True, decode='bxx_decode', no_fast_wrapper=True),
            Instr('c.slli',     Format_CI1U,'000 --- --- -- --- 10', fast_handler=True),
            Instr('c.lwsp',     Format_CI3, '010 --- --- -- --- 10', fast_handler=True, tags=["load"]),
            Instr('c.jr',       Format_CR1, '100 0-- --- 00 000 10', fast_handler=True, no_fast_wrapper=True),
            Instr('c.mv',       Format_CR2, '100 0-- --- -- --- 10', fast_handler=True),
            Instr('c.ebreak',   Format_CR,  '100 100 000 00 000 10'),
            Instr('c.jalr',     Format_CR3, '100 1-- --- 00 000 10', fast_handler=True, no_fast_wrapper=True),
