...
class PulpV2(IsaSubset):
    ...
    def __init__(self):
        super().__init__(name='pulpv2', instrs=[
            ...
            Instr('p.beqimm',        Format_SB2, '------- ----- ----- 010 ----- 1100011', fast_handler=True, decode='bxx_decode', no_fast_wrapper=True),
            Instr('p.bneimm',        Format_SB2, '------- ----- ----- 011 ----- 1100011', fast_handler=True, decode='bxx_decode', no_fast_wrapper=True),
